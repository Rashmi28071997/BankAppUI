					...
					<a href="${pageContext.request.contextPath }/statement" style="text-decoration: none; ">
						<div class="card bg-info mb-3"
							...
							<div class="card-body">
								...
								<p class="card-text">Get to know the status of the account.</p>
							</div>
						</div>
					</a>
				</div>
					...
					<a href="${pageContext.request.contextPath }/balance" style="text-decoration: none; ">
						<div class="card bg-info mb-3"
							...
							<div class="card-body">
								...
								<p class="card-text">Check the balance in your account.</p>
							</div>
						</div>
					</a>
				</div>
					...
					<a href="${pageContext.request.contextPath }/settings" style="text-decoration: none; ">
						<div class="card bg-info mb-3"
							...
							<div class="card-body">
								...
								<p class="card-text">get to know about Account setting.</p>
							</div>
						</div>
					</a>
				</div>
					...
					<a href="${pageContext.request.contextPath }/help" style="text-decoration: none; ">
						<div class="card bg-info mb-3"
							...
							<div class="card-body">
								...
								<p class="card-text">Get helps from here and any question.</p>
							</div>
						</div>
					</a>
				</div>
